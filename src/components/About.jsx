            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <p>
                                Founded in the heart of the city, <span className="text-primary-700 font-bold">Chator Adda</span> began with a simple mission: to create a space where people could disconnect from their busy lives and reconnect with each other over an exceptional cup of coffee.
                            </p>
                            <p>
